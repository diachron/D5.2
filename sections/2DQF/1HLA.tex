...
Tools such as Trellis~\cite{Gil2002}, WIQA~\cite{Bizer2008:PhDThesis:biblatex} and Sieve~\cite{Mendes2012} implement a number of metrics but lacked flexibility w.r.t.\ the level of automation, and user friendliness~\cite{Zaveri2012:LODQ} 
...
The unit provides a number of helper classes that provide inferencing queries on vocabularies that describe metrics (such as DQM) based on the core ontology - Dataset Quality Ontology (daQ).
