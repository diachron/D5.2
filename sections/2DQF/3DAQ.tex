...
Instead these should be inherited as parent classes and properties for more specific quality protocols.
...
\item[daq:Metric€“] is smallest unit of measuring a quality dimension.
