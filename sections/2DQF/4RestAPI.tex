...
Listing~\ref{lst:api_format} shows a sample input message format with the newly added parameter \textbf{MetricsConfiguration}\todo{CL@JD: If others implement their own metrics in packages other than de.unibonn.iai.eis... how will this work?  It currently implicitly maps to de.unibonn..., doesn't it?}.
