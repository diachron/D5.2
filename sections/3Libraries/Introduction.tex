...
OntoWiki is part of the LOD2 Stack, available under the \todo{CL@JD: which version?}GPL open source license.
\todo{CL@JD: Isn't this too general?  It's rather just the visualisation component, isn't it?}The Quality Framework is currently based on OntoWiki.
...
\label{sec:Sesame}
\todo{CL@JD: What are we using this for?  Isn't Jena sufficient? - JD: Forth added this for their implementation. I still need to see what they did.}OpenRDF Sesame\footnote{\url{http://www.openrdf.org/}} is  a de-facto standard framework for processing RDF data. 
...
\subsection{Virtuoso}
\label{sec:Virtuoso}
\todo{CL@JD: Somewhere please use a \emph{simple} terminology.  It's a \emph{triple store}.}Virtuoso\footnote{\url{http://virtuoso.openlinksw.com/}} is an innovative enterprise grade multi-model data server for agile enterprises and individuals.
