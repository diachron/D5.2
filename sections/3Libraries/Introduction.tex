...
\label{sec:Sesame}
\todo{CL@JD: What are we using this for?  Isn't Jena sufficient?}OpenRDF Sesame\footnote{\url{http://www.openrdf.org/}} is  a de-facto standard framework for processing RDF data. 
