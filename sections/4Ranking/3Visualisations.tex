...
The UI will communicate with the core assessment framework (cf. Figure~\todo{CL: broken reference}\ref{fig:hla}) via the defined RESTful APIs (cf. Section~\ref{sec:RestAPI}).
