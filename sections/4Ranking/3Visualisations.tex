...
\label{sec:UI} 
In the following section, we will describe a set of mockups which will be implemented as a Web User Interface (UI) for the assessment and ranking of datasets software prototype.
...
Similar procedure is done to populate the metric box. 
