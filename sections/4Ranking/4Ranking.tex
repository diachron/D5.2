...
Consider $F_{m} = \lbrace m_{1},m_{2},\dots,m_{n} \rbrace$ where $F_{m}$ is the set of \todo{CL: IIUC $m_1$ is the \emph{value} of metric 1, right?}the values of all metrics $m$ available.
